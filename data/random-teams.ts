...
const ContraryMoves = [
	'closecombat', 'leafstorm', 'overheat', 'superpower', 'vcreate', 'subzerofury', 'stormcrash', 'psychoboost', 'dracometeor',
];
...
const SpecialSetup = [
	'calmmind', 'chargebeam', 'geomancy', 'nastyplot', 'quiverdance', 'tailglow', 'turbocharge', 'hyperfocus',
];
